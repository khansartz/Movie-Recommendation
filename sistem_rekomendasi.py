...
- Melakukan pembersihan data genre dengan mengganti label yang tidak jelas dan menyamakan format penulisan.
...
def movie_recommendations(movie_name, similarity_data=cosine_sim_df, items=movie_new[['movie_name', 'genre']], k=5):
    ...
    # Ambil posisi k film dengan similarity terbesar ke movie_name
...
data[data.movie_name.eq('Grudge 3, The (2009)')]

# Mendapatkan rekomendasi film yang mirip
movie_recommendations('Grudge 3, The (2009)')
